...
plot(deri_est1$X_ord[qry_range], Y_deriv_noisy1[qry_range], pch=16, xlab = "X", ylab = TeX("$m'(x), \\hat{m}'(x)$"), col="green", cex.lab=2, cex.axis=2, cex=0.7)
points(deri_est1$X_ord[qry_range], Y_deriv_trans1[qry_range], pch=16, col="blue", cex=0.7)
lines(x_qry, True_deriv1, col="black", lwd=5)
legend(-0.03, 9.7, legend=c(TeX("Noisy $\\hat{m}'(x)$"), TeX("Smoothed $\\hat{m}'(x)$"), "True derivative"), fill=c("green", "blue", "black"), cex=1.5)
```
