...
MAE6$proposed_unif = MAE_prop6[MAE_prop6$scenario == "Oracle", "MAE_adj"]

boxplot(MAE6[c("locpol3", "locpol4", "locpol5", "psplines", "proposed", "proposed_unif")], ylab="MAEadjusted")
```
...
text(tick, par("usr")[3] - 30000, names(sort(colMeans(MAE6[sapply(MAE6, is.numeric)]))), srt = 45, xpd = TRUE)
```

```{r}
MAE6_sub = MAE6[c("locpol3", "locpol4", "locpol5", "psplines", "proposed", "proposed_unif")]
