...
abline(h = max(Y_deriv_trans), col="black", lty="dashed", lwd = 3)
legend("bottomleft", legend=c("Proposed Estimator", "Locpol with p=2", "Cubic psplines"), fill=c("red", "orange", "blue", "black"), cex=1.5)
```
